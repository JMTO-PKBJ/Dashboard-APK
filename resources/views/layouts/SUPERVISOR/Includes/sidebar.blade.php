<ul class="navbar-nav sidebar sidebar-dark accordion" id="accordionSidebar" style="background-color: #0C2754; position: fixed; top: 0; left: 0; height:100%; overflow-y: auto;">
    ...
    <li class="nav-item">
        ...
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
            <div class="bg-white py-2 aboutCCTV collapse-inner rounded">
                <a class="collapse-item" href="{{ route('supervisor.cctv') }}">Lihat CCTV</a>
                <a class="collapse-item" href="{{ route('supervisor.cctv.create') }}">Tambah CCTV</a>
            </div>
        </div>
        <a class="nav-link" href="{{ route('supervisor.events') }}">
    ...
    {{-- <div class="text-center d-none d-md-inline">
        <button class="r    ounded-circle border-0" id="sidebarToggle"></button>
    </div> --}}
