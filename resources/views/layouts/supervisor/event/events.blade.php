...
@section('content')
        ...
        <div class="card-body">
            <div class="d-flex">
                ...
                <div class="col-sm-3 ruas d-flex justify-content-center align-items-center">
                    ...
                    <form method="GET" action="{{ route('supervisor.exportPDF') }}" class="d-inline" >
    ...
    <script>
        ...
        $(document).ready(function() {
            $.ajax({
                url: '{{ route("supervisor.getCctvRuas") }}',
                method: 'GET',
            ...
            $(document).on('click', '.ruas-item', function(e) {
                ...
                $.ajax({
                    url: '{{ route("supervisor.getCctvLocations") }}',
                    method: 'GET',
                    data: { ruas: ruas },
                    success: function(response) {
