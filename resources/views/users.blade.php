                                ...
                                <div class="modal-body">
                                    <form action="{{ url('api/users/' . $user['id']) }}" method="POST">
                                        ...
                                        <div class="newPass p-3">
                                            New Password
                                            <div class="input-group">
                                                <input class="form-control text-field" style="border-radius: 7px 0 0 7px;" type="password" name="password" id="password-{{ $user['id'] }}" placeholder="Enter your new password">
                                        ...
                                        <div class="role p-3">
                                            Role
                                            <select class="form-select" name="role_id" id="role_id-{{ $user['id'] }}" aria-label="Default select example">
