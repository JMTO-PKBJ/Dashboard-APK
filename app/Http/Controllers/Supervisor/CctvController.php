    ...
    public function create()
{
    ...
    return view('layouts.SUPERVISOR.Cctv.addCCTV', compact('cctvRuas', 'cctvLokasi', 'cctvs'));
}
...
public function store(Request $request){
    ...
    if ($validator->fails()) {
        ...
        return redirect()->route('supervisor.cctv.create')->with('success', 'CCTV added successfully.');
    }
    ...
    {
        $cctvs = Cctv::all();
        return view('layouts.SUPERVISOR.Cctv.viewCCTV', compact('cctvs'));
    }

    public function showAdd()
    {
        $cctvs = Cctv::all();
        return view('layouts.SUPERVISOR.Cctv.addCCTV', compact('cctvs'));
    }
}
