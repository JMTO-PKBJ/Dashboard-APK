...
class cctvController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('layouts.operator.cctv.addCCTV', compact('cctvRuas', 'cctvLokasi', 'cctvs'));
    }
...
public function store(Request $request){
    ...
    if ($validator->fails()) {
        ...
        return redirect()->route('operator.cctv.create')->with('success', 'CCTV added successfully.');
    }
    ...
    {
        $cctvs = cctv::all();
        return view('layouts.operator.cctv.viewCCTV', compact('cctvs'));
    }

    public function showAdd()
    {
        $cctvs = cctv::all();
        return view('layouts.operator.cctv.addCCTV', compact('cctvs'));
    }
}
